-- Parcial 3 PDM115 - CLAVE 2
-- Estudiante: VJ21002
-- Base de datos: control de Doctores y Hospitales - Ministerio de Salud

CREATE DATABASE IF NOT EXISTS salud_vj21002
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE salud_vj21002;

-- Tabla de especialidades medicas (referencia para hospitales)
